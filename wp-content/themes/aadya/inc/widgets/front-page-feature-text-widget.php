...
class aadya_frontpage_featured_text_widget extends WP_Widget {
		...
		private $icons_font_awesome = array(
         ...
         public function __construct() {
			...
			/* Widget settings. */
			$widget_ops = array( 'classname' => 'front-page-feature-text', 'description' => __('Front Page Feature Text for Marketing.', 'aadya') );
        ...
        public function form( $instance ) {
			...
			aadya_widget_field( $this, array ( 'field' => 'feature_description', 'label' => __( 'Description:', 'aadya' ), 'type' => 'textarea'), $instance['feature_description'] );
			...
			aadya_widget_field( $this, array ( 'field' => 'feature_icon', 'type' => 'icon-select', 
															   'label' => __( 'Feature Icon:', 'aadya' ),
        ...
        public function widget( $args, $instance ) {	
            ...
            echo '<i class="fa '.$feature_icon.' feature-icon"></i>';
    		echo '<div class="desc">';
    		echo '<h4>'.$title.'</h4>';            
			echo '<p>' . do_shortcode( $feature_description ) .'</p>';
			if ( ! empty( $action_url ) && ! empty( $action_label ) ) {
			  echo '<p><a href="'.esc_url( $action_url ).'" class="btn btn-xs btn-'.esc_attr( $action_color ).'" role="button">'.esc_attr( $action_label ).'</a> </p>';
			 } 
    		echo '</div>';
    		echo '</div>';		
			echo $after_widget;
