				...
				<div class="col-md-9 col-sm-9" id="wrapper">
					...
					<?php while ( have_posts() ) : the_post(); ?>
						...
						if ( is_singular( 'attachment' ) ) {
							...
							the_post_navigation( array(
								'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'charity-fundraiser' ) . '</span> ' .
									'<span class="screen-reader-text">' . __( 'Next post:', 'charity-fundraiser' ) . '</span> ' .
									'<span class="post-title">%title</span>',
								'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'charity-fundraiser' ) . '</span> ' .
