                            ...
                            <div class="entry-content">
                                ...
                                <div class="entry-attachment">
                                    <div class="attachment">
                                        <?php charity_fundraiser_the_attached_image(); ?>
                                    </div>
                                ...
                                <?php
                                    the_content();
                                    wp_link_pages( array(
                                        'before' => '<div class="page-links">' . __( 'Pages:', 'charity-fundraiser' ),
                                        'after'  => '</div>',
                                    ) );
                                ?>
                            </div>    
                            <?php edit_post_link( __( 'Edit', 'charity-fundraiser' ), '<footer class="entry-meta"><span class="edit-link">', '</span></footer>' ); ?>
                        </article>    
                        <?php
